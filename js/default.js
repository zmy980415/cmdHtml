...
$(document).ready(function() {
    ...
    $("#appCmd").append("<div id='cmHead'><span class='env'></span><span class='user'></span><span class='text'></span></div>");
    $("#appCmd").append("<div id='cmdDiv'><span class='env'></span><span class='user'></span><input id='cmdInput' autocomplete='off'/></div>");
    ...
    $("#cmdInput").on('keydown', function(event) {
        if(event.key === 'Enter'){
            ...
            if(cmd !== ""){
                if(cmd !== 'clear'){     
                    $("#cmHead").append("<br/><span class='env'></span><span class='user'></span><span class='text'>"+cmd+"</span>");
                    $("#cmHead").find(".env").text("["+env+"]");
                    $("#cmHead").find(".user").text("["+user+"]");
                }
                cmdHandle($("#appCmd"),cmd);
            }else{
                cmdHandle($("#appCmd"),cmd);
                $("#cmHead").append("<br/><span class='env'></span><span class='user'></span><span class='text'>"
                    +$("#cmdInput").val()+"</span>");
                $("#cmHead").find(".env").text("["+env+"]");
                $("#cmHead").find(".user").text("["+user+"]");
            }
